...
namespace Modules\NewsCategories\src\Http\Controllers;
...
class NewCategoryController extends Controller
{
    ...
    public function __construct(NewsCategoriesRepositoryInterface $newsCategoriesRepository)
    {
    ...
    {
        $pageTitle = "Quản lí danh mục tin tức";
