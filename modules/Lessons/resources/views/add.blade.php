    ...
    <div class="row-cols-auto">
        <form action="{{ route('admin.lessons.store',$courseId) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3 mt-3">
                        ...
                        <select class="form-control select2 @if($errors->has('parent_id')) is-invalid @endif"
                            ...
                            {!!   getLesson($lessons,old('parent_id'),request()->get('module'))  !!}
                        </select>
                        @error('parent_id')
                        <div class="invalid-feedback">
                            {{$message}}
                ...
                <div class="col-6">
                    <div class="mb-3 mt-3">
                        ...
                        <select class="form-control @if($errors->has('is_trial')) is-invalid @endif" id="is_trial"
                                name="is_trial">
                            <option value="0" {{ old('is_trial') == 0 ? ' selected' : false }}>Không cho phép</option>
                            <option value="1" {{ old('is_trial') == 1 ? ' selected' : false }}>Có cho phép</option>
                        </select>
                        @error('is_trial')
                        <div class="invalid-feedback">
                            {{$message}}
                ...
                <div class="col-12">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="number"
                               ...
                               id="position"
                               placeholder="Enter position" name="position" value="{{ old('position',$position) }}">
                        @error('position')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                ...
                <div class="col-6">
                    <div class="mb-3 mt-3">
                        <label for="video_id" class="form-label">Link Video Embed Youtube, Mã Nhúng Iframe Hoặc Chọn Video:</label>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <div class="input-group">
                            <input type="text"
                                   ...
                                   id="document_id"
                                   placeholder="Tài liệu bài giảng" name="document_id" value="{{ old('document_id') }}">
