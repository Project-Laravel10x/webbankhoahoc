                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="blog">
                        <div class="blog-image">
                            <a href="blog-details.html"><img class="img-fluid" src="{{ asset('client/assets/img/blog/blog-05.jpg') }}" alt="Post Image"></a>
                        </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="post-author">
                                            <a href="instructor-profile.html"><img src="{{ asset('client/assets/img/user/user.jpg') }}" alt="Post Author"> <span>Ruby Perrin</span></a>
                                        </div>
                                    </li>
                                    <li><img class="img-fluid" src="{{ asset('client//img/icon/icon-22.svg') }}" alt>April 20, 2022</li>
                                    <li><img class="img-fluid" src="{{ asset('client/assets/img/icon/icon-23.svg') }}" alt>Programming, Web Design</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="blog-info clearfix">
                            <div class="post-left">
                                <ul>
                                    ...
                                    <li><img class="img-fluid" src="assets/img/icon/icon-22.svg" alt>May 20, 2021</li>
