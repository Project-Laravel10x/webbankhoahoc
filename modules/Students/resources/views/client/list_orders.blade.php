                        ...
                        <div class="settings-menu p-0">
                            ...
                            <div class="profile-group">
                                <div class="profile-name text-center">
                                    <h4>
                                        <a href="student-profile.html">{{ \Illuminate\Support\Facades\Auth::guard('students')->user()->name }}</a>
                                    </h4>
                                    <p>Học viên</p>
                                </div>
                                ...
                                <div class="settings-invoice-blk table-responsive">
                                    ...
                                    <table class="table table-borderless mb-0">
                                        ...
                                        @foreach($orders as $order)
                                            <tr>
                                                <td><a href="#" class="invoice-no">#{{ $order->id }}</a></td>
                                                <td>{{ $order->created_at }}</td>
                                                <td>{{ formatCurrency($order->total) }}</td>
                                                <td><span class="badge status-completed">Thành công</span></td>
                                                <th><a href="{{ route('students.detailOrder',$order->id) }}"
                                                       class="btn btn-warning">Chi tiết</a></th>
                                                <td><a href="javascript:void(0);" class="btn-style"><i
                                                            class="feather-download"></i></a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
