                ...
                <div class="col-xl-3 col-md-4 theiaStickySidebar">
                        ...
                        <div class="settings-menu p-0">
                            ...
                            <div class="profile-group">
                                <div class="profile-name text-center">
                                    <h4>
                                        <a href="#">{{ \Illuminate\Support\Facades\Auth::guard('students')->user()->name }}</a>
                                    </h4>
                                    <p>Học viên</p>
                                </div>
                                <div class="go-dashboard text-center">
                                    <a href="{{ route('students.dashBoard') }}" class="btn btn-primary">Đến trang
                                        Dashboard</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="settings-widget account-settings">
                        <div class="settings-menu">
                            ...
                            <ul>
                                <li class="nav-item ">
                                    <a href="{{ route('students.editProfile') }}" class="nav-link">
                                        <i class="feather-settings"></i> Chỉnh sửa thông tin
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('students.viewDeteleProFile') }}" class="nav-link">
                                        <i class="feather-trash-2"></i> Vô hiệu hóa tài khoản
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a href="{{ route('students.logout') }}" class="nav-link">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-block">
                                                ...
                                                <input @if($errors->has('name')) style="border: 1px solid red;" @endif
                                                type="text" name="name"
                                                       class="form-control  "
                                                       placeholder="Nhập họ và tên..." value="{{ $student->name }}">
                                            </div>
                                            @error('name')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-block">
                                                ...
                                                <input @if($errors->has('phone')) style="border: 1px solid red;"
                                                       @endif type="text" name="phone" class="form-control"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-block">
                                                ...
                                                <input @if($errors->has('email')) style="border: 1px solid red;"
                                                       @endif type="text" name="email" class="form-control"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-block">
                                                ...
                                                <input @if($errors->has('address')) style="border: 1px solid red;"
                                                       @endif type="text" name="address" class="form-control"
                                                       placeholder="Nhập địa chỉ..." value="{{ $student->address }}">
                                            </div>
                                            @error('address')
                                            <div class="invalid-feedback d-block">
                                                {{$message}}
                                        ...
                                        <div class="personal-info-head">
                                            <h4>Đổi mật khẩu</h4>
                                            <p>Nếu bạn không muốn đổi mật khẩu vui lòng bỏ qua</p>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="input-block">
                                                <label class="form-control-label">Mật khẩu cũ:</label>
                                                <input @if($errors->has('old_password')) style="border: 1px solid red;"
                                                       @endif type="password" name="old_password" class="form-control"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-block">
                                                ...
                                                <input @if($errors->has('password')) style="border: 1px solid red;"
                                                       @endif type="password" name="password" class="form-control"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-block">
                                                ...
                                                <input
                                                    @if($errors->has('password_confirmation')) style="border: 1px solid red;"
                                                    @endif type="password" name="password_confirmation"
                                                    class="form-control"
                                        ...
                                        <div class="update-profile">
                                            <button type="submit" class="btn btn-primary">Cập nhật thông tin cá nhân
                                            </button>
                                        </div>
                                    </div>
                                </form>
