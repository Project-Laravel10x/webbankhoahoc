                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    <div class="view-icons">
                                        <a href="" class="list-view active"><i class="fa-solid fa-list"></i></a>
                                    </div>
                                    <div class="show-result">
                                        <h4>Xem {{ $students->firstItem() }}-{{ $students->lastItem() }}
                                            của {{ $students->total() }} kết quả</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
