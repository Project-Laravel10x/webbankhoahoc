        ...
        <div class="col-md-6 login-wrap-bg">
            ...
            <div class="login-wrapper">
                <div class="loginbox">
                    <div class="w-100">
                        ...
                        <form action="{{ route('clients.login') }}" method="POST">
                            ...
                            <div class="forgot">
                                <span><a class="forgot-link" href="{{ route('clients.forgot_password') }}">Quên mật khẩu ?</a></span>
                            </div>
                ...
                <div class="google-bg text-center">
                    ...
                    <p class="mb-0">New User ? <a href="{{ route('clients.register') }}">Create an Account</a></p>
                </div>
            </div>
