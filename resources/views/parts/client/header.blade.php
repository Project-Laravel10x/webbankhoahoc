                    ...
                    <div class="main-menu-wrapper">
                        ...
                        <ul class="main-nav">
                            ...
                            <li class="has-submenu">
                                ...
                                @endphp
                                <ul class="submenu" style="max-height: 200px; overflow-y: auto">
                    ...
                    <ul class="nav header-navbar-rht">
                        ...
                        <span class="status online  "></span>
                            ...
                            <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
                                ...
                                <a class="dropdown-item" href="{{ route('students.myCourses') }}"><i
                                        class="feather-user me-1"></i> Khóa học của tôi</a>
                                <a class="dropdown-item" href="{{ route('students.dashBoard') }}"><i
                                        class="feather-star me-1"></i>Dashboard</a>

                                <a class="dropdown-item" href="{{ route('students.logout') }}"><i
