...
@if(\Illuminate\Support\Facades\Auth::guard('students')->user() != null)
...
<span></span>
                        ...
                        <ul class="main-nav">
                            ...
                            <li class="has-submenu">
                                <a href>Danh mục <i class="fas fa-chevron-down"></i></a>
                                    @php
                                        $categoriesData = (new \Modules\Categories\src\Repositories\CategoriesRepository())->getCategories()->toArray();
                    ...
                    <ul class="nav header-navbar-rht">
                        <li class="nav-item">
                            <a href="course-message.html"><img
                        ...
                        <li class="nav-item wish-nav">
                            <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                                <img src="{{ asset('client/assets/img/icon/wish.svg') }}  " alt="img">
                            </a>
                                    ...
                                    <ul class="notification-list">
                                        <li class="notification-message">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body">
                                                    <h6><a href="notifications.html">Lex Murphy requested <span>access to</span>
                            ...
                            <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
                                <div class="user-header">
                                    <div class="avatar avatar-sm">
                                        <img src="data:image/png;base64," alt="User Image"
                                             class="avatar-img rounded-circle">
                                    </div>
                                    <div class="user-text">
                                        <h6>{{ Auth::guard('students')->user()->name }}</h6>
                                ...
                                <a class="dropdown-item" href="{{ route('students.logout') }}"><i class="feather-log-out me-1"></i>
                                    Đăng xuất</a>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="header-fixed">
            <nav class="navbar navbar-expand-lg header-nav scroll-sticky">
                <div class="container">
                    ...
                    <ul class="nav header-navbar-rht">
                        <li class="nav-item">
                            <a class="nav-link header-sign" href="{{ route('students.login') }}">Đăng nhập</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link header-login" href="{{ route('students.register') }}">Đăng ký</a>
                        </li>
                    </ul>
                </div>
            </nav>
