                ...
                <div class="main-menu-wrapper">
                    ...
                    <ul class="main-nav">
                        <li class="has-submenu active">
                            <a class href>Trang chủ <i class="fas fa-chevron-down"></i></a>
                            <ul class="submenu">
                                <li class="active"><a href="index-2.html">Trang chủ</a></li>
                            </ul>
                        </li>
                        <li class="has-submenu">
                            <a href>Người hướng dẫn <i class="fas fa-chevron-down"></i></a>
                            <ul class="submenu">
                        ...
                        <li class="has-submenu">
                            <a href>Học viên <i class="fas fa-chevron-down"></i></a>
