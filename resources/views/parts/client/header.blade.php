                        ...
                        <li class="has-submenu active">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="has-submenu active">
                                    ...
                                    <ul class="submenu">
                                        <li class="active"><a href="add-course.html">Add Course</a></li>
                                    ...
                                    <li>
                                        <div class="media">
                                            <div class="d-flex media-wide">
                                                ...
                                                <div class="media-body">
                                                    <h6><a href="course-details.html">Build Responsive Real...</a>
                                                    </h6>
                                                    <p>Jenis R.</p>
                                                    <h5>$200 <span>$99.00</span></h5>
                                                </div>
                                    ...
                                    <li>
                                        <div class="media">
                                            <div class="d-flex media-wide">
                                                ...
                                                <div class="media-body">
                                                    <h6><a href="course-details.html">C# Developers Double ...</a>
                                                    </h6>
                                                    <p>Jesse Stevens</p>
                                                    <h5>$200 <span>$99.00</span></h5>
                                                </div>
                                ...
                                <ul class="notification-list">
                                        ...
                                        <div class="media d-flex">
                                            ...
                                            <div class="media-body">
                                                <h6><a href="notifications.html">Ray Arnold left 6
                                                        <span>comments on</span> Isla Nublar SOC2 compliance report</a>
                                                </h6>
                                        ...
                                        <div class="media d-flex">
                                            ...
                                            <div class="media-body">
                                                <h6><a href="notifications.html">Dennis Nedry
                                                        <span>commented on</span> Isla Nublar SOC2 compliance report</a>
                                                </h6>
                                    ...
                                    <li class="notification-message">
                                        <div class="media d-flex">
                                            ...
                                            <div class="media-body">
                                                <h6><a href="notifications.html">John Hammond <span>created</span>
...
<span class="status online"></span>
                        ...
                        <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
                            ...
                            <a class="dropdown-item" href="index-2.html"><i class="feather-log-out me-1"></i> Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
